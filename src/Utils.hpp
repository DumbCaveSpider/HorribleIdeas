...
namespace horrible {
    ...
    static inline const std::vector<Option> allOptions = {
        ...
        {"placebo",
         "Placebo",
         "A random chance that when you start a level, all the horrible mods you have enabled are disabled, or all the horrible mods you have disabled are enabled.\n<cy>Credit: tmdXD</c>",
         Category::misc,
         SillyTier::High},
        {"click_speed",
         "Click Player Speed",
