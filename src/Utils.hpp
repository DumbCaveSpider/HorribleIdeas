...
namespace horrible {
    ...
    static inline const std::vector<Option> allOptions = {
        ...
        {"math_quiz",
         "Richard's Math Quiz!",
         "When playing a level in practice mode, there's a chance Richard will pop out and give you a quick math quiz. Answer correctly to continue, or restart a level from the beginning.\n<cy>Credit: CyanBoi</c>",
