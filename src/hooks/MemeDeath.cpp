...
class $modify(MemePlayerObject, PlayerObject)
{
    struct Fields
    {
    ...
    void playerDestroyed(bool p0)
    {
        if (m_fields->enabled)
        {
            ...
            int percentage = PlayLayer::get()->getCurrentPercentInt(); // get da current percentage when ded
